const jobsSeedData = [
  {
    companyName: "AI Labs & Solutions Pvt. Ltd.",
    jobRoleName: "AI / Machine Learning Engineer (Fresher)",
    description:
      "We are looking for an enthusiastic AI/ML Engineer Fresher with a strong foundation in Artificial Intelligence, Machine Learning, Deep Learning, and Full Stack development. The candidate will work on real-world AI-driven applications, LLM-based systems, and scalable web platforms using modern technologies.",
    ...
    explanation:
      "This role is ideal for an AI Developer Fresher with hands-on experience in Machine Learning, Deep Learning, and Large Language Models. The candidate will build and optimize AI models, work on LLM-based applications, and integrate them into full-stack systems. Knowledge of MERN stack enables end-to-end product development, while experience with projects like GPT-2 implementation and AI healthcare platforms aligns strongly with the role. The position involves collaborating with cross-functional teams, continuous learning, and applying AI solutions to real-world problems. It is well-suited for candidates passionate about innovation, research, and scalable AI-driven systems.",
  },
  {
    companyName: "Tech Innovations Inc.",
    jobRoleName: "Frontend Developer",
    description:
      "Looking for a skilled Frontend Developer with expertise in React, TypeScript, and modern web technologies. You'll be building responsive user interfaces and collaborating with cross-functional teams.",
    location: "Bangalore, Karnataka",
    type: "Full-time",
  ...
  },
  {
    ...
    description:
      "Manage CI/CD pipelines, automate deployments, and maintain cloud infrastructure. Experience with AWS, Docker, and Kubernetes required.",
  ...
  },
  {
    ...
    explanation:
      "A Mobile App Developer creates applications for mobile platforms. The role involves developing native or cross-platform applications. Developers work with frameworks like React Native or Flutter. They implement UI/UX designs and ensure smooth user experiences. Performance optimization for mobile devices is crucial. Understanding of mobile-specific constraints and capabilities is important. The role demands knowledge of mobile app stores and deployment. Mobile developers test applications across different devices and OS versions. They play a key role in delivering mobile solutions for business needs.",
  },
  {
    companyName: "WebSolutions Ltd.",
    jobRoleName: "Full Stack Developer",
    description:
      "Build end-to-end web applications using MERN stack. Handle both frontend and backend development with modern best practices.",
    location: "Bangalore, Karnataka",
    type: "Full-time",
    experience: "3-5 years",
    salary: "₹12-18 LPA",
  ...
  },
  {
    ...
    description:
      "Lead product strategy and roadmap. Work with engineering, design, and business teams to deliver exceptional products.",
    ...
    explanation:
      "A Product Manager defines product vision and strategy. The role involves market research and prioritizing features. Managers work with engineering, design, and business teams. They create product roadmaps and define success metrics. Understanding of user needs and market trends is crucial. Experience with agile methodologies is important. The role demands leadership and communication skills. Product managers make data-driven decisions about product features. They play a key role in ensuring products meet market needs and business objectives.",
  },
  {
    companyName: "Quality First Labs",
    jobRoleName: "QA Engineer",
    description:
      "Design and execute test cases, perform automated testing, and ensure software quality. Experience with Selenium and testing frameworks.",
    location: "Pune, Maharashtra",
    type: "Full-time",
    experience: "2-4 years",
    salary: "₹7-11 LPA",
  ...
  },
  {
    ...
    explanation:
      "A Cybersecurity Analyst protects organizational systems and data. The role involves monitoring security threats and incidents. Analysts conduct vulnerability assessments and penetration testing. They implement security measures and protocols. Understanding of network architecture and security tools is crucial. Experience with SIEM platforms is important. The role demands analytical thinking and threat assessment skills. Cybersecurity analysts create security reports and recommendations. They play a key role in safeguarding organizational digital assets.",
  },
  {
    companyName: "AI Innovations",
    jobRoleName: "Machine Learning Engineer",
    description:
      "Develop and deploy ML models, work with large datasets, and optimize algorithms for production environments.",
    location: "Bangalore, Karnataka",
    type: "Full-time",
    experience: "2-5 years",
    salary: "₹15-22 LPA",
  ...
  },
  {
    ...
    explanation:
      "A Content Writer creates engaging written content for various platforms. The role involves researching topics and creating compelling narratives. Writers work with marketing and editorial teams to develop content strategies. They optimize content for SEO and audience engagement. Understanding of different content formats is important. Proficiency in writing and research is essential. The role demands creativity and attention to detail. Content writers adapt tone and style for different audiences. They play a key role in building brand presence and audience engagement.",
  },
  {
    companyName: "MarketPro Agency",
    jobRoleName: "Digital Marketing Manager",
    description:
      "Plan and execute digital marketing campaigns across multiple channels. Expertise in SEO, SEM, and social media marketing.",
    location: "Hyderabad, Telangana",
    type: "Full-time",
    experience: "3-6 years",
    salary: "₹10-16 LPA",
  ...
  },
  {
    ...
    description:
      "Build data pipelines, design data warehouses, and ensure data quality. Experience with Spark and Hadoop preferred.",
    location: "Bangalore, Karnataka",
    type: "Full-time",
    experience: "3-5 years",
    salary: "₹13-19 LPA",
  ...
  },
  {
    ...
    description:
      "Drive sales growth, build client relationships, and achieve revenue targets. Strong communication skills essential.",
    location: "Mumbai, Maharashtra",
    type: "Full-time",
    experience: "1-3 years",
    salary: "₹5-9 LPA",
  ...
  },
  {
    ...
    description:
      "Create technical documentation, user manuals, and API documentation for software products.",
    location: "Remote",
    type: "Remote",
    experience: "1-3 years",
    salary: "₹5-8 LPA",
